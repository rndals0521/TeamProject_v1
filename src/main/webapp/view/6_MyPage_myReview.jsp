		...
		<div class="contents">
			<div class="container">
				...
				<div class="bodybox">
					...
					<br>
						<div style="cursor: pointer;" class="myPageList" onclick="" onmouseover="">회원 정보</div>
						<div class="myPageList" onclick="" onmouseover="">즐겨찾기 리스트</div>
						<div class="myPageList" onclick="" onmouseover="">나의 리뷰</div>
					<br>
					<p style="text-align: left; font-size: 25pt; margin-bottom: 20px; font-weight: bold;">나의리뷰</p>
								  	...
								  	<table class="board_list">
								  		...
								  		<thead>
								  			<tr>
								  				...
								  				<th style="width: 18%;">글삭제</th> <!-- 삭제버튼 누를시 복구버튼으로 전환 -->
								   			</tr>
								  		</thead> 
								  		<tbody>
								        <tr>
