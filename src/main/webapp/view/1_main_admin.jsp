...
<body>
	...
	<%@ include file="0_Top_beom_login_admin.jsp" %>
	<div class="section">
	...
	<div class="slidewrap">
		...
		<div class="contents">
			<div class="container">
			<h2>영화<i class="fas fa-cog" style="margin-left: 5px;"></i></h2>
			</div>		
			<div class="container">
			...
			<div class="container">
			<h2>도서<i class="fas fa-cog" style="margin-left: 5px;"></i></h2>
			</div>		
			<div class="container">
			<i class="fas fa-chevron-circle-left" style="font-size: 30px;"></i>
				<div class="item_box">
		...
		<div class="container">
			<h2>드라마<i class="fas fa-cog" style="margin-left: 5px;"></i></h2>
			</div>		
			<div class="container">
			<i class="fas fa-chevron-circle-left" style="font-size: 30px;"></i>
				<div class="item_box">
